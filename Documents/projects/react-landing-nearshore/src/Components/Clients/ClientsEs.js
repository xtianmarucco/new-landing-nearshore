                ...
                <div className="client-card container col-md-10 col-xs-12 ">
                  ...
                  <div className="client-testimony text-left ">
                    ...
                    <p>
                      ...
                      considero casi familia. Amplia experiencia y conocimientos
                      técnicos, siempre tienen el personal adecuado para encarar
                      cualquier tipo de proyecto. Incluirlos en proyectos a
                      largo plazo fue una excelente decisión.
                    </p>
                  </div>
                </div>
              </div>
              <div className="carousel-item">
                <div className="client-card container col-md-10 col-xs-12 ">
                  ...
                  <div className="client-testimony text-left ">
                    ...
                    <p>
                      Devlights es un gran equipo con el cual trabajar, no solo
                      tienen las habilidades para realizar el trabajo, sino que
                      también se comunican de manera efectiva a lo largo de todo
                      el proyecto. ¡Su equipo era exactamente lo que necesitaba!
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="client-card container col-md-10 col-xs-12">
                  ...
                  <div className="client-testimony text-left ">
                    ...
                    <p>
                      ...
                      experiencia. El equipo tiene los conocimientos, responde y
                      son muy amables. Realmente los recomiendo para cualquier
                      tipo de proyecto ya sea grande o pequeño.
                    </p>
                  </div>
                </div>
              </div>
