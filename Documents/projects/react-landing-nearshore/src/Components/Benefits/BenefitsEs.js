    ...
    <div className="container">
      ...
      <div className="row flex-grid benefits-container">
        <div className="benefit-card text-center col-md-4 col-sm-12 col-xs-12">
          ...
          <br />
          <p>
            Tenemos gente capaz de unirse a su equipo sin problemas, las
            relaciones interpersonales son fundamentales para nosotros. Podemos
            armar un nuevo equipo para que puedan comenzar su proyecto o hacerse
            cargo de uno ya existente sin restricciones como el lenguaje o
        ...
        <div className="benefit-card text-center col-md-4 col-sm-12 col-xs-12">
          ...
          <br />
          <p>
            Las relaciones a largo plazo con nuestros clientes son muy
            importantes para nosotros y son uno de los valores fundamentales
            para Devlights. Procuramos crear un fuerte vínculo con nuestros
            clientes para poder trabajar juntos de la mejor manera y ayudarlos a
            alcanzar sus metas en el largo plazo.
          </p>
        </div>
      </div>
    </div>
